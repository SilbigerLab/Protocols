...
1. Additional Program Parameters
    ...
    1. "HY1" is used to select the amount of temperature change below the high temperature alarm relay will reset, this value is usually "1". Select "1" with the arrow buttons and press the "SET/ENT" button six times to enter the correct value and advance to the "JC" display. Or if the value is correct, press the "SET/ENT" button five times to advance to the "JC" display.
